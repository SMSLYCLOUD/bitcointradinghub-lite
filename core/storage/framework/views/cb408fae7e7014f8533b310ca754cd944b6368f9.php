                    ...
                    <div class="row gy-4 justify-content-center">
                        <div class="col-md-4 pe-lg-5 pe-md-4 justify-content-center">
                            <div class="img-choose-div">
                                ...
                                <label for="imageUpload" class="editImg btn main-btn w-100"><?php echo e(__('Choose file')); ?></label>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="update">
                            ...
                            <button class="btn main-btn mt-3 w-100"><?php echo e(__('Update')); ?></button>
                        </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/profile.blade.php ENDPATH**/ ?>