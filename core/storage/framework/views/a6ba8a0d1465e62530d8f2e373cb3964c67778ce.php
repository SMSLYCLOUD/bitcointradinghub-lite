            ...
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="<?php echo e(route('user.forgot.password')); ?>" method="POST">
                        ...
                        <?php endif; ?>
                        <button type="submit" id="recaptcha" class="btn main-btn w-100"><?php echo e(__('Send Verification Code')); ?></button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/auth/forgot_password.blade.php ENDPATH**/ ?>