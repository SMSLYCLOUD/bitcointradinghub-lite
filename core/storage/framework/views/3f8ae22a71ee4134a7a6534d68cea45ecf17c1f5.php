                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <button class="btn main-btn mt-4" type="submit"><?php echo e(__('Send Proof For Payment ')); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/gateway/bank.blade.php ENDPATH**/ ?>