                ...
                <div class="col-xxl-2 col-lg-3 col-sm-4 col-6">
                    <div class="payment-box text-center">
                        ...
                        <div class="payment-box-content">
                            ...
                            <button data-href="<?php echo e(route('user.paynow', $gateway->id)); ?>" data-id="<?php echo e($gateway->id); ?>" class="btn main-btn w-100 paynow mt-3"><?php echo e(__('Pay Now')); ?></button>
                        </div>
                    </div>
                </div>
            ...
            <form action="" method="post">
                ...
                <div class="modal-content bg-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn main-btn"><?php echo e(__('Deposit Now')); ?></button>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/gateway/gateways.blade.php ENDPATH**/ ?>