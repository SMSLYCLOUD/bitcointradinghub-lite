                ...
                <div class="site-card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <button type="submit" class="btn main-btn w-100" id="basic-addon2"><?php echo e(__('Transfer Money')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make(template() . 'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/transfer_money.blade.php ENDPATH**/ ?>