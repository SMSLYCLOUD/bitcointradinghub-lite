        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <form action="<?php echo e(route('contact')); ?>" method="post" role="form" class="php ">
                    ...
                    <div class="mt-3">
                        <button class="btn main-btn w-100" type="submit"><?php echo e(__('Send Message')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
</div><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/sections/contact.blade.php ENDPATH**/ ?>