            ...
            <div class="card-header">
                <div class="row gy-4"> 
                    ...
                    <div class="col-md-4  text-md-end text-center">
                        <button id="new-ticket" class="btn main-btn btn-sm"><?php echo e(__('Create Ticket')); ?> <i class="fa fa-envelope"
                ...
                <div class="modal-content bg-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn main-btn"><?php echo e('Create Ticket'); ?></button>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <div class="modal-content bg-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal"><?php echo e(__('Close')); ?></button>
                                <button type="submit" class="btn main-btn"><?php echo e('Update Ticket'); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/ticket/list.blade.php ENDPATH**/ ?>