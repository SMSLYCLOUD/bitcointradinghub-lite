                ...
                <div class="auth-form-wrapper">
                    ...
                    <form action="<?php echo e(route('user.register')); ?>" method="POST">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-12">
                                <button class="btn main-btn w-100" type="submit"> <?php echo e(__('Register')); ?> </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/auth/register.blade.php ENDPATH**/ ?>