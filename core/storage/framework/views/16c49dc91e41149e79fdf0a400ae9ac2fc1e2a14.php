...
?>
    ...
    <section class="plan-section sp_pt_120 sp_pb_120 sp_separator_bg" style="background-image: url('<?php echo e(asset('asset/theme3/images/bg/plan.jpg')); ?>')">
        <div class="container">
    ...
    <div class="calculate-area">
        ...
        <div class="container">
            <div class="row gy-4 align-items-end">
                ...
                <div class="col-lg-3">
                    <a href="#0" id="calculate-btn" class="btn main-btn w-100"> <?php echo e(__('Calculate Earning')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/sections/plan.blade.php ENDPATH**/ ?>