            ...
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="" method="POST">
                        ...
                        <?php endif; ?>
                        <button class="btn main-btn w-100 mt-3" type="submit"> <?php echo e(__('Log In')); ?> </button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitcointradinghub.org/public_html/core/resources/views/theme3/user/auth/login.blade.php ENDPATH**/ ?>